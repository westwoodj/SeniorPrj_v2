...
**Pip:**
```bash
pip3 install Twint-master
```

or

```bash
pip3 install --user --upgrade git+https://github.com/twintproject/twint.git@origin/master#egg=Twint-master
```

**Pipenv**:
```bash
pipenv install git+https://github.com/twintproject/twint.git#egg=Twint-master
```
